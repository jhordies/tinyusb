...
**Key Combination**: **Left Shift + Right Shift** (hold for 500ms)

- **Left Shift**: [1,15] - Left Shift key (clearly labeled)
- **Right Shift**: [2,15] - Right Shift key (clearly labeled)
...
1. Hold **Left Shift + Right Shift** for 500ms
...
1. Hold **Left Shift + Right Shift** for 500ms again
...
- **Left Shift**: [1,15] - Left Shift key
- **Right Shift**: [2,15] - Right Shift key
